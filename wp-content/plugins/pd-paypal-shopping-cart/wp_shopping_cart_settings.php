...
{    
    ...
    echo '<div class="wrap">'.screen_icon( ).'<h2>'.(__("PD Simple Paypal Shopping Cart Options", "WSPSC")).'</h2>';
    $current = "";
    if(isset($_GET['page'])){
        $current = $_GET['page'];
...
function show_wp_cart_options_page () 
{
	...
	?>
 	<h2><?php _e("Perspektive Designs PayPal Shopping Cart Settings", "WSPSC"); ?> v <?php echo WP_CART_VERSION; ?></h2>
 	
 	<div style="background: none repeat scroll 0 0 #FFF6D5;border: 1px solid #D1B655;color: #3F2502;margin: 10px 0;padding: 5px 5px 5px 10px;text-shadow: 1px 1px #FFFFFF;">	
 	<p><?php _e("Please contact Brandon Thomas at Perspektive Designs with any questions about usage or functionality", "WSPSC"); ?>
    </div>
	...
	<p><strong><?php _e("Step 2) ","WSPSC"); ?></strong><?php _e("To create a product listing add the following shortcode", "WSPSC"); ?> [wpsc_product_display] <?php _e("to a post or page.", "WSPSC"); ?></p>
        <p><?php _e("Example shopping cart shortcode usage:", "WSPSC");?> <p style="background-color: #DDDDDD; padding: 5px; display: inline;">[wpsc_product_display]</p></p>
    <p><strong><?php _e("Step 3) ","WSPSC"); ?></strong><?php _e("To add the shopping cart to a post or page (example: a checkout page) simply add the shortcode", "WSPSC"); ?> [show_wp_shopping_cart] <?php _e("to a post or page or use the sidebar widget to add the shopping cart to the sidebar.", "WSPSC"); ?></p>
