...
function paupress_post_actions() {
	
	return apply_filters( 'paupress_post_actions', array( 
...
function paupress_get_init_post_actions() {
	return apply_filters( 'paupress_get_init_post_actions', paupress_post_actions() ); 
}
...
function paupress_get_post_actions() {
	return apply_filters( 'paupress_get_post_actions', paupress_post_actions() ); 
}
 ...
 * @return null If you don't see your actions, it didn't work. :)
 */
function paupress_init_post_actions() {
  
  	$paupress_post_actions = paupress_get_init_post_actions();
  	
	foreach ( $paupress_post_actions as $action ) {
		...
		$args = paupress_init_post_actions_args( $labels, $cptype, $args );
		/*
		//$args['label'] = null;
		$args['labels'] = $labels;
		$args['description'] = '';
		...
		$args['register_meta_box_cb'] = 'paupress_post_actions_meta_box_cb';
...
function paupress_init_post_actions_args( $labels, $cptype, $args = null ) {
	...
	$defaults = array( 
						...
						'map_meta_cap' => false, 
						'hierarchical' => false, 
						'register_meta_box_cb' => 'paupress_post_actions_meta_box_cb', 
						'taxonomies' => array(), 
...
function paupress_post_actions_nonce_field() {
	global $post, $ppnonce;
	if ( false == $ppnonce ) {
