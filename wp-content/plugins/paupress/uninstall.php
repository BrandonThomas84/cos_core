...
// REMOVE ROLES
$pp_caps = get_option( '_paupress_capabilities' );
...
// DELETE THE OPTIONS
$wpdb->query("DELETE FROM $wpdb->options WHERE option_name LIKE '%paupress%';");
//$wpdb->query("DELETE FROM $wpdb->options WHERE option_name LIKE '%paupanels%';");
