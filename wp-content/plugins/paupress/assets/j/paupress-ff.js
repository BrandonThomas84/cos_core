...
function paupress_get_post_to_edit() {
	...
	jQuery('#'+fid+' .paupress-viewer').empty().html('<img src="'+paupressAjax.ajaxload+'" />');
...
function paupress_save_new_post() {
	...
	// EMPTY OUT THE MAIN HOLDER'S ELEMENTS AND PLAY THE LOADER
	jQuery('#'+sid+' div.paupress-viewer').empty().html('<img src="'+paupressAjax.ajaxload+'" />');
...
jQuery(document).ready(function () {
	...
	jQuery('.paupress-profile a.nav-tab').live('click', function() {
	...
	// PROFILE ACTIONS
	jQuery('#paupress').on('click', '.paupress-view', paupress_action_view);
	jQuery('#paupress').on('click', '.paupress-icon', paupress_icon_toggle);
	jQuery('#paupress').on('change', '.profile-actions-filter', paupress_select_toggle);
